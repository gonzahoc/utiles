...
app.use(cors({
  origin: ['https://www.stipa.org.ar', 'https://stipa.org.ar'], // Permite ambos dominios
...
app.post('/api/formulario', upload.any(), (req, res) => {
    res.status(200).json({ error: 'copeee' });
});
// app.post('/api/formulario', upload.any(), (req, res) => {
//   try {
...
//     res.status(500).json({ error: 'Failed to process form data', details:err });
//   }
// });
